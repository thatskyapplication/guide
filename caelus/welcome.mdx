...
<img
  src="/images/welcome-example-1.webp"
  alt="Welcome Example 1"
  title="Welcome Example 1"
  className="mr-auto"
  style={{ width:"41%" }}
/>

<img
  src="/images/welcome-example-2.webp"
  alt="Welcome Example 2"
  title="Welcome Example 2"
  className="mr-auto"
  style={{ width:"41%" }}
/>